...
<div class="form-group">
    <label for="addr" class="control-label col-sm-2">Address:</label>
      <div class="col-sm-5"><textarea id="addr" rows="5" name="addr" class="form-control" "></textarea>
    </div>
...
<div class="form-group">
        ...
        <div class="col-sm-5">
            <textarea placeholder="Describe your company" name="about"class="form-control" rows="5" "></textarea>
