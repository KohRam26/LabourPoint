    ...
    <nav class="navbar">
        <div class="navbar" id="insidenav">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">Labour Point</a>
            </div>
            <ul class="nav navbar-nav">
                <li class="active"><a href="profile.php">Profile<span class="sr-only">(current)</span></a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Applied Jobs<span class="caret"></span></a>
       ...
       <div class="container-fluid" id="advsearch" >
           ...
           <form role="form">
              <table>
                  ...
                  <tr>
                    <td class="tbold">Jobs:</td>
                    <td>
                      <div class="dropdown"> <select name="Jobs" id="qual" class=" form-control" required>
